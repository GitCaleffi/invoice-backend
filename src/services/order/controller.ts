...
//   (r.arrivalDate && new Date(r.arrivalDate) <= new Date(r.requested_date));
...
//         requested_date: r.requested_date, // just show from DB
//         status: r.status || "Open",
//         deliveryStatus: isOnTime ? "In tempo" : "Tardi",
//       };
//     });

//     // Header summary (optional, no nearest date)
//     const allOnTime = lineItems.every((item) => item.deliveryStatus === "In tempo");
//     const orderSummary = {
//       order_number: orderNumber,
//       deliveryStatus: allOnTime ? "In tempo" : "Tardi",
//       orderStatus: null, // keep null or remove if not needed
//     };
